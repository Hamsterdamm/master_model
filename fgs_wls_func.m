function [ output ] = fgs_wls_func( input, guidance, lambda, T, interpolate )
...
for t=1:T
    ...
    temp=fgs_wls_h(temp,guidance,lam, interpolate);
    temp=fgs_wls_v(temp,guidance,lam, interpolate);
end
...
function [ output ] = fgs_wls_h( input, guidance, lambda, interpolate )
...
function [ output ] = fgs_wls_v( input, guidance, lambda, interpolate )
%UNTITLED6 Summary of this function goes here
%   Detailed explanation goes here
